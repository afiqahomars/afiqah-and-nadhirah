...
# Custom CSS styling for a modern, sleek presentation look
st.markdown("""
    <style>
...
if df is not None:
    ...
    # 2. Interactive Cancellation Filter (New UI Control)
    ...
    # --- CHART 2: PLOTLY AREA CHART (HOURLY ORDER TRENDS) ---
    with col2:
    ...
    if len(df_filtered) > 0:
        ...
        # Interactive Scatter Plot utilizing Ordinary Least Squares (OLS) trend line
        ...
        # Fixed syntax error line using raw-string format (r"...")
        ...
        st.warning("No operational data records found matching the active sidebar parameters.")
